...
case VCol of
  ...
  begin
    ...
    with Sender as TDrawGrid do
    begin
      FDragSource := FGame.SuitPile(suHeart);
      FDraggingPile := False;
      FDragSourceIndex := -1;
      BeginDrag(false,5);
    end;
  ...
  begin
    ...
    with Sender as TDrawGrid do
    begin
      FDragSource := FGame.SuitPile(suSpade);
      FDraggingPile := False;
      FDragSourceIndex := -1;
      BeginDrag(false,5);
    end;
  ...
  begin
    ...
    with Sender as TDrawGrid do
    begin
      FDragSource := FGame.SuitPile(suDiamond);
      FDraggingPile := False;
      FDragSourceIndex := -1;
      BeginDrag(false,5);
    end;
  ...
  begin
    ...
    with Sender as TDrawGrid do
    begin
      FDragSource := FGame.SuitPile(suClub);
      FDraggingPile := False;
      FDragSourceIndex := -1;
      BeginDrag(false,5);
    end;
...
3: begin
     if FGame.SuitPile(suHeart).Acceptable(FDragSource.Top) then
     begin
       Accept:= true;
     end
     else
...
4: begin
     if FGame.SuitPile(suSpade).Acceptable(FDragSource.Top) then
     begin
       Accept:= true;
     end
     else
...
5: begin
     if FGame.SuitPile(suDiamond).Acceptable(FDragSource.Top) then
     begin
       Accept:= true;
     end
     else
...
6: begin
     if FGame.SuitPile(suClub).Acceptable(FDragSource.Top) then
     begin
       Accept:= true;
     end
     else
...
3: begin
     ...
     FGame.MoveCard(FDragSource, FGame.SuitPile(suHeart));

   end;

4: begin

     FGame.MoveCard(FDragSource, FGame.SuitPile(suSpade));

   end;

5: begin

     FGame.MoveCard(FDragSource, FGame.SuitPile(suDiamond));

   end;

6: begin

     FGame.MoveCard(FDragSource, FGame.SuitPile(suClub));
...
1..7:
  ...
  if FGame.CanMoveSubPile( VRow +1 , (FDragSource as TTableauPile), FGame.TableauPile(VCol)) then
     Accept := true;
  else
  begin
    Accept := false;
...
DeckDrawGrid.MouseToCell(x,y,VCol,VRow);
 ...
 case VCol of
1..7:
  FGame.MoveSubPile( VRow + 1, (FDragSource as TTableauPile), FGame.TableauPile(VCol))
